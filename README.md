...
- [ASP.NET Core web API](https://dotnet.microsoft.com/apps/aspnet/apis) 
  ...
  - [Dependency Injection](https://docs.microsoft.com/en-us/dotnet/core/extensions/dependency-injection) [[Brief Tutorial](https://www.youtube.com/watch?v=YR6HkvNBpX4)]
